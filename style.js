...
oxfordFlippedApp.homepage = function(data,updateHash) {
	...
	if (oxfordFlippedApp.config.firstTime) {
		...
		var totalHtml = '<div id="oxfl-general">'+homeHtml+lessonsHtml+unitHtml+marketplaceHtml+marketplaceInnerHtml+customHtmlByUser+' </div> '+modalLockChaptersHtml+modalNotificationsHtml+modalConnectionHtml+modalNoCoinsHtml+modalMarketplaceInfoHtml;
