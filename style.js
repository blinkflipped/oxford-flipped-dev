...
oxfordFlippedApp.text = {
	...
	gradebookintro: textweb('style_flipped_gradebook_description'),
	gradebooktitle2: textweb('style_flipped_gradebook_lessons_available'),
	gradebooktitle3: textweb('style_flipped_gradebook_lessons_completed'),
	gradebooktitle4: textweb('style_flipped_gradebook_overall_status'),
	gradebooktitle5: textweb('style_flipped_gradebook_stars_average'),
	gradebooktitle6: textweb('style_flipped_gradebook_awards'),
	gradebookcaption1: textweb('style_flipped_gradebook_status1'),
	gradebookcaption2: textweb('style_flipped_gradebook_status2'),
	gradebookcaption3: textweb('style_flipped_gradebook_status3'),
	gradebooktableheader1: textweb('style_flipped_gradebook_lesson_name'),
	gradebooktableheader2: textweb('style_flipped_gradebook_status'),
	gradebooktableheader3: textweb('style_flipped_gradebook_stars'),
	gradebookawards1: textweb('style_flipped_gradebook_awards1'),
	gradebookawards2: textweb('style_flipped_gradebook_awards2'),
	gradebookawards3: textweb('style_flipped_gradebook_awards3'),
	chooseclassresources: textweb('style_flipped_classresources_title'),
	noclassresources: textweb('style_flipped_noresources'),
	contentzoneinfotitle: textweb('style_flipped_contentzone_box_title'),
	contentzoneinfotext: textweb('style_flipped_contentzone_box_text'),
	modalDatepicker1: 'Please, pick a due date for this lesson',
	modalDatepicker2: 'Set date'
}
...
oxfordFlippedApp.hashDistributor = function(currentHash,data,updateHash) {
	...
	} else if (currentHash === oxfordFlippedApp.config.tree[7].hash) { // Professor Resources
...
oxfordFlippedApp.homepage = function(data,updateHash) {
	...
	if (oxfordFlippedApp.config.firstTime) {
		...
		var homeHtml = '<div id="oxfl-custom-background"><div id="oxfl-custom-background-inner-1"></div> <div id="oxfl-custom-background-inner-2"></div> </div>  <div id="oxfl-home-title"><div><div class="oxfl-title5">'+oxfordFlippedApp.text.text1+'</div><h1 class="oxfl-title1">'+bookTitle+'</h1></div></div>  <div id="oxfl-general-buttons"><button class="oxfl-button-icon oxfl-button-icon-home oxfl-js-gohome"> <span>'+oxfordFlippedApp.text.buttonhome+'</span> </button> <button class="oxfl-button-icon oxfl-button-icon-info oxfl-js-open-info" style="display: none"> <span>'+oxfordFlippedApp.text.buttoninfo+'</span> </button> <button class="oxfl-button-icon oxfl-button-icon-marketplace oxfl-js-load-marketplace"> <span>'+oxfordFlippedApp.text.buttonmarketplace+'</span> </button> <button class="oxfl-button oxfl-button-icon oxfl-button-icon-goback oxfl-js-goback disabled"> <span>'+oxfordFlippedApp.text.buttongoback+'</span></button></div>'+coinsElem+'<button id="oxfl-notifications" class="oxfl-js-open-notifications"><div class="oxfl-notifications-badge"></div></button><div id="oxfl-home-menu"><div id="oxfl-home-menu-inner" class="oxfl-container"><div class="oxfl-home-menu-item">'+customButton+'</div><div class="oxfl-home-menu-item"><button class="oxfl-monster oxfl-monster-2 oxfl-js-load-episodes" id="oxfl-goto-prepare"><span>'+oxfordFlippedApp.text.buttonprepare+'</span></button></div><div class="oxfl-home-menu-item"><button class="oxfl-monster oxfl-monster-3 oxfl-js-load-marketplace" id="oxfl-goto-marketplace"><span>'+oxfordFlippedApp.text.buttonmarketplace+'</span></button><div class="oxfl-bubble-hello"><div class="oxfl-bubble-hello-inner"><span class="oxfl-bubble-hello-text">'+oxfordFlippedApp.text.hello+' </span><span class="oxfl-bubble-hello-name">'+username+'</span></div></div></div></div></div>',
				...
				modalDatepicker = '<div class="modal fade oxfl-modal oxfl-modal-2" id="oxfl-modal-datepicker" tabindex="-1" role="dialog" aria-hidden="true"> <div class="modal-dialog modal-dialog-centered" role="document"> <div class="modal-content"> <div class="modal-header"> <div class="oxfl-modal-datepicker-monster"></div><button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button> </div> <div class="modal-body"> <div class="oxfl-datepicker-wrapper"> <div class="oxfl-datepicker-content"> <div class="oxfl-datepicker-content-left"> <div class="">'+oxfordFlippedApp.text.modalDatepicker1+'</div> <button class="oxfl-button oxfl-button-bubble oxfl-button-bubble-5">'+oxfordFlippedApp.text.modalDatepicker2+'</button> </div> <div class="oxfl-datepicker-content-right"> <div class="oxfl-modal-datepicker">  <div class="oxfl-modal-datepicker-form"> <div class="form-group"> <input type="text" readonly> <div id="oxfl-datepicker" class="oxfl-datepicker"></div> </div> </div> </div> </div> </div> </div> </div> </div> </div> </div>';
		...
		$('body').on('click', '.oxfl-js-load-classresources', function() {
...
oxfordFlippedApp.loadNotifications = function(data) {
	...
	var $notifWrapper = $('#oxfl-notifications-list'),
			$notifButton = $('#oxfl-notifications');
	$notifWrapper.empty();
	$notifButton.removeClass('active').find('.oxfl-notifications-badge').text('');
	...
	if (totalNotif > 0) {
		...
		$notifButton.addClass('active').find('.oxfl-notifications-badge').text(totalNotif);
	...
	if ($('.oxfl-chapter').length) {
		$('.oxfl-chapter:not(.oxfl-chapter-challenge)').each(function(i,e) {
			...
			if (!isChapterNew) {
				...
				$(e).find('.oxfl-stars').removeClass('oxfl-stars-hidden oxfl-stars-filled-0 oxfl-stars-filled-1 oxfl-stars-filled-2 oxfl-stars-filled-3').addClass('oxfl-stars-filled-'+newStars);
				...
				if (grade > oxfordFlippedApp.config.minGrade && grade != '') {
					if (isChallenge) {
						var finalSlideBackground = $lastSlide.find('.image_slide').attr('src'),
								customSound = '<div style="display: none"><audio autoplay><source src="'+oxfordFlippedApp.sounds[3]+'" type="audio/mpeg"></audio></div>',
								...
								finalSlideContent = '<div id="oxfl-final-slide">'+customSound+customAnimation+'<div class="oxfl-final-slide-stars" id="oxfl-final-slide-stars"></div><div class="oxfl-coins-bubble-2"><div class="oxfl-coins-bubble-2-coins" id="oxfl-total-coins-2"></div></div><button class="oxfl-button-bubble oxfl-button-bubble-3 oxfl-js-close-iframe-inside">'+oxfordFlippedApp.text.exit+'</button></div>';
					...
					if (isChallenge) {
						var finalSlideBackground = $lastSlide.find('.image_slide').attr('src'),
								customSound = '<div style="display: none"><audio autoplay><source src="'+oxfordFlippedApp.sounds[1]+'" type="audio/mpeg"></audio></div>',
								...
								finalSlideContent = '<div id="oxfl-final-slide">'+customSound+customAnimation+'<div class="oxfl-final-slide-stars" id="oxfl-final-slide-stars"></div><div class="oxfl-final-slide-fail-buttons"><button class="oxfl-button-bubble oxfl-button-bubble-2 oxfl-js-go-to-start">'+oxfordFlippedApp.text.tryagain+'</button><div class="oxfl-separate-text">'+oxfordFlippedApp.text.or+'</div><button class="oxfl-button-bubble oxfl-button-bubble-3 oxfl-js-close-iframe-inside">'+oxfordFlippedApp.text.exit+'</button></div></div>';
						if (finalSlideBackground != '') {
							$lastSlide.css('background-image', 'url('+finalSlideBackground+')').find('.slide_aux').hide();
						}
						$lastSlide.addClass('oxfl-final-slide-challenge');
					} else {
						var customSound = '<div style="display: none"><audio autoplay><source src="'+oxfordFlippedApp.sounds[2]+'" type="audio/mpeg"></audio></div>',
								customAnimation = '<div id="drops-falling"><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i><i class="rain"></i></div>',
								finalSlideContent = '<div id="oxfl-final-slide">'+customSound+customAnimation+'<div class="oxfl-final-slide-stars" id="oxfl-final-slide-stars"></div><div class="oxfl-final-slide-fail-buttons"><button class="oxfl-button-bubble oxfl-button-bubble-2 oxfl-js-tryagain">'+oxfordFlippedApp.text.tryagain+'</button><div class="oxfl-separate-text">'+oxfordFlippedApp.text.or+'</div><button class="oxfl-button-bubble oxfl-button-bubble-3 oxfl-js-close-iframe-inside">'+oxfordFlippedApp.text.exit+'</button></div></div>';
						$lastSlide.removeClass('oxfl-final-slide-challenge');
					}
...
oxfordFlippedApp.challengeCover = function() {
	...
	$('.oxfl-challenge-cover').each(function(i,e) {
		...
		var customAnimation = '<div id="nube" class="animated slow delay-1 fadeInLeft infinite"> <div id="nube_abajo"></div> <div id="nube_derecha"></div> <div id="nube_izquierda"></div> </div> <div id="peq_nube" class="animated slow fadeInLeft infinite"> <div id="peq_nube_abajo"></div> <div id="peq_nube_derecha"></div> <div id="peq_nube_izquierda"></div> </div> <div id="peq_nube-two" class="animated slow fadeInRight infinite delay-1"> <div id="peq_nube-two_abajo"></div> <div id="peq_nube-two_derecha"></div> <div id="peq_nube-two_izquierda"></div> </div> <div id="peq_nube-three" class="animated slow fadeInRight infinite"> <div id="peq_nube-three_abajo"></div> <div id="peq_nube-three_derecha"></div> <div id="peq_nube-three_izquierda"></div> </div>';
