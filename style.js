...
oxfordFlippedApp.text = {
	...
	buttonresources : 'Class resources',
...
oxfordFlippedApp.loadNotifications = function(data) { // TODO CHECK NOTIF
			...
			$.each(chapters, function(x, chapter){
				...
				if (!notifChapterIsChallenge) {
					...
					var isChapterNew = (typeof window.actividades[notifChapterID] === 'undefined' || window.actividades[notifChapterID].custom_activity_status === oxfordFlippedApp.config.stateNew || typeof window.actividades[chapter.id].custom_activity_status === 'undefined'),
							isChapterNotCompleted = ((typeof window.actividades[chapter.id].custom_activity_status !== 'undefined' && window.actividades[notifChapterID].custom_activity_status !== oxfordFlippedApp.config.stateCompleted) || typeof window.actividades[chapter.id].custom_activity_status === 'undefined');
