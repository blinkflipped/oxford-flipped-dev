		...
		*/
		onCourseDataLoaded: function(data) {
			...
			if (isBookCover) {
				...
				//TODO TEST oxfordFlippedApp.homepage(data, updateHash);
			}
		},
...
oxfordFlippedApp.text = {
	...
	exit: textweb('style_flipped__lesson_finalko_button2'),
	tryagain: textweb('style_flipped__lesson_finalko_button1'),
	or: textweb('style_flipped__lesson_finalko_or'),
