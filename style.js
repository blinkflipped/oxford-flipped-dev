...
oxfordFlippedApp.homepage = function(data,updateHash) {
	...
	if (oxfordFlippedApp.config.firstTime) {
		...
		var homeHtml = '<div id="oxfl-custom-background"><div id="oxfl-custom-background-inner-1"></div> <div id="oxfl-custom-background-inner-2"></div> </div>  <div id="oxfl-home-title"><div><div class="oxfl-title5">'+oxfordFlippedApp.text.text1+'</div><h1 class="oxfl-title1">'+bookTitle+'</h1></div></div>  <div id="oxfl-general-buttons"><button class="oxfl-button-icon oxfl-button-icon-home oxfl-js-gohome"> <span>'+oxfordFlippedApp.text.buttonhome+'</span> </button> <button class="oxfl-button-icon oxfl-button-icon-info oxfl-js-open-info" style="display: none"> <span>'+oxfordFlippedApp.text.buttoninfo+'</span> </button> <button class="oxfl-button-icon oxfl-button-icon-marketplace oxfl-js-load-marketplace"> <span>'+oxfordFlippedApp.text.buttonmarketplace+'</span> </button> <button class="oxfl-button oxfl-button-icon oxfl-button-icon-goback oxfl-js-goback disabled"> <span>'+oxfordFlippedApp.text.buttongoback+'</span></button></div><div id="oxfl-coins"><div id="oxfl-coins-icon"></div><div id="oxfl-coins-total">'+totalCoins+'</div></div><button id="oxfl-notifications" class="oxfl-js-open-notifications"><div class="oxfl-notifications-badge"></div></button><div id="oxfl-home-menu"><div id="oxfl-home-menu-inner" class="oxfl-container"><div class="oxfl-home-menu-item"><button class="oxfl-monster oxfl-monster-1" id="oxfl-goto-gradebook"><span>'+oxfordFlippedApp.text.buttongradebook+'</span></button></div><div class="oxfl-home-menu-item"><button class="oxfl-monster oxfl-monster-2 oxfl-js-load-episodes" id="oxfl-goto-prepare"><span>'+oxfordFlippedApp.text.buttonprepare+'</span></button></div><div class="oxfl-home-menu-item"><button class="oxfl-monster oxfl-monster-3 oxfl-js-load-marketplace" id="oxfl-goto-marketplace"><span>'+oxfordFlippedApp.text.buttonmarketplace+'</span></button><div class="oxfl-bubble-hello"><div class="oxfl-bubble-hello-inner"><span class="oxfl-bubble-hello-text">'+oxfordFlippedApp.text.hello+' </span><span class="oxfl-bubble-hello-name">'+username+'</span></div></div></div></div></div>',
				...
				gradebookAwardsHtml = '<div class="oxfl-gradebook-award oxfl-gradebook-award-1 inactive" id="oxfl-gradebook-award-1"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.percent.bronze+' '+oxfordFlippedApp.text.gradebookawards1+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-2 inactive" id="oxfl-gradebook-award-2"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.percent.silver+' '+oxfordFlippedApp.text.gradebookawards1+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-3 inactive" id="oxfl-gradebook-award-3"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.percent.gold+' '+oxfordFlippedApp.text.gradebookawards1+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-4 inactive" id="oxfl-gradebook-award-4"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.coins.bronze+' '+oxfordFlippedApp.text.gradebookawards2+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-5 inactive" id="oxfl-gradebook-award-5"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.coins.silver+' '+oxfordFlippedApp.text.gradebookawards2+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-6" id="oxfl-gradebook-award-6 inactive"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.coins.gold+' '+oxfordFlippedApp.text.gradebookawards2+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-7 inactive" id="oxfl-gradebook-award-7"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.lessonthreestars.bronze+' '+oxfordFlippedApp.text.gradebookawards3+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-8 inactive" id="oxfl-gradebook-award-8"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.lessonthreestars.silver+' '+oxfordFlippedApp.text.gradebookawards3+'</div> </div> </div> <div class="oxfl-gradebook-award oxfl-gradebook-award-9 inactive" id="oxfl-gradebook-award-9"> <div class="oxfl-gradebook-award-inner"> <div class="oxfl-gradebook-award-label">'+oxfordFlippedApp.config.awards.lessonthreestars.gold+' '+oxfordFlippedApp.text.gradebookawards3+'</div> </div> </div>',
