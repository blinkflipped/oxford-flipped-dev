...
oxfordFlippedApp.loadMarketplaceList = function(data,type,itemperpage) {
		...
		for(var i = 0; i < itemsLength; i+=itemperpage) {
			items.slice(i, i+itemperpage).wrapAll('<div class="oxfl-resource-page"></div>');
		}
