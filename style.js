						...
						var resourceType = resource.type;
								...
								if ((type === 'game' && resourceType === activityHTML) || (type === 'summary' && resourceType !== activityHTML)) {
									var resourceTitle = resource.title,
											...
											resourceOnClick = (!oxfordFlippedApp.config.isStudent || (oxfordFlippedApp.config.isStudent && !resourceStateNew)) ? resource.onclickTitle : 'oxfordFlippedApp.oxflMarketplaceModal('+resourceValue+', '+resourceTitle.toString()+','+resourceDescription.toString()+','+resourceId+')',
...
oxfordFlippedApp.oxflMarketplaceModalInfo = function(resourceToken,resourceTitle,resourceDescription,resourceID) {
	...
	console.log(resourceToken,resourceTitle,resourceDescription,resourceID);
...
$(document).ready(function() {
	...
	blink.events.on('vocabulary:done', (function() {
		...
		// PROBAR EN OTRO QUE NO SEA MEMORY
	}));
